            ...
            if (action.equals("1")) {
                ...
                while (!goBack) {
                    ...
                    if (action.equals("1")) {
                        ...
                        if (db.selectOneUser(customer_id).size() != 0) {
                            ...
                            System.out.println("Invalid customer id '" + customer_id + "'");
                        }
                    } else if (action.equals("3")) {
                        ...
                        if (db.selectOneUser(customer_id).size() != 0) {
                            ...
                            while (discount_code.length() == 0) {
                                ...
                                if (db.selectOneGroup(discount_code).size() == 0) {
                                    System.out.println("User group '" + discount_code + "' does not exist, please re-enter");
                                    discount_code = "";
                                }
                            }
                            // valid discount code
                            if (db.selectAMembership(customer_id, discount_code).size() != 0) {
                                System.out.println("Customer " + customer_id + " is already in user group '" + discount_code + "'");
                            } else if (db.insertOneMembership(customer_id, discount_code)) {
                                System.out.println("Successfully added customer " + customer_id + " into user group '" + discount_code + "'");
                            } else {
                                System.out.println("Cannot add customer " + customer_id + " into user group '" + discount_code + "', internal failure");
                            }
                        } else {
                            System.out.println("Invalid customer id '" + customer_id + "'");
                        }
                        ...
                        if (db.selectOneUser(customer_id).size() != 0) {
                            ...
                            while (o_id.length() == 0) {
                                ...
                                if (!validOrderID.contains(o_id)) {
                                    System.out.println("Cannot find incomplete order of this user with order id " + o_id);
                                    o_id = "";
                                }
                            }
                            // parse order id
